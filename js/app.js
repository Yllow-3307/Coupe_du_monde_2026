...
const TEAMS_DATA = [
  ...
  {flag:"🇨🇦",name:"Canada",group:"B",coach:"Jesse Marsch",players:[
    {n:1,pos:"G",name:"Dayne St. Clair"},
    {n:2,pos:"D",name:"Alistair Johnston"},
    {n:3,pos:"D",name:"Alfie Jones"},
    {n:4,pos:"D",name:"Luc de Fougerolles"},
    {n:5,pos:"D",name:"Joel Waterman"},
    {n:6,pos:"M",name:"Mathieu Choinière"},
    {n:7,pos:"M",name:"Stephen Eustáquio"},
    {n:8,pos:"M",name:"Ismaël Koné"},
    {n:9,pos:"A",name:"Cyle Larin"},
    {n:10,pos:"A",name:"Jonathan David"},
    {n:11,pos:"A",name:"Liam Millar"},
    {n:12,pos:"A",name:"Tani Oluwaseyi"},
    {n:13,pos:"D",name:"Derek Cornelius"},
    {n:14,pos:"M",name:"Jacob Shaffelburg"},
    {n:15,pos:"D",name:"Moïse Bombito"},
    {n:16,pos:"G",name:"Maxime Crépeau"},
    {n:17,pos:"A",name:"Tajon Buchanan"},
    {n:18,pos:"A",name:"Olise David"},
    {n:19,pos:"D",name:"Alphonso Davies"},
    {n:20,pos:"A",name:"Ali Ahmed"},
    {n:21,pos:"M",name:"Jonathan Osorio"},
    {n:22,pos:"D",name:"Richie Laryea"},
    {n:23,pos:"G",name:"Owen Goodman"},
    {n:24,pos:"M",name:"Nathan Saliba"},
    {n:25,pos:"D",name:"Niko Sigur"},
    {n:26,pos:"A",name:"Jayden Nelson"},
  ]},
  {flag:"🇧🇦",name:"Bosnie-Herzégovine",group:"B",coach:"Sergej Barbarez",players:[
    {n:1,pos:"G",name:"Nikola Vasilj"},
    {n:2,pos:"D",name:"Nihad Mujakic"},
    {n:3,pos:"D",name:"Dennis Hadzikadunic"},
    {n:4,pos:"D",name:"Tarik Muharemovic"},
    {n:5,pos:"D",name:"Sead Kolasinac"},
    {n:6,pos:"M",name:"Benjamin Tahirovic"},
    {n:7,pos:"D",name:"Amar Dedic"},
    {n:8,pos:"M",name:"Armin Gigovic"},
    {n:9,pos:"A",name:"Samed Bazdar"},
    {n:10,pos:"A",name:"Ermedin Demirovic"},
    {n:11,pos:"A",name:"Edin Dzeko"},
    {n:12,pos:"G",name:"Filip Jurkas"},
    {n:13,pos:"M",name:"Ivan Basic"},
    {n:14,pos:"M",name:"Ivan Sunjic"},
    {n:15,pos:"M",name:"Amar Memic"},
    {n:16,pos:"M",name:"Amir Hadziahmetovic"},
    {n:17,pos:"M",name:"Dzenis Burnic"},
    {n:18,pos:"D",name:"Nikola Katic"},
    {n:19,pos:"A",name:"Kerim Alajbegovic"},
    {n:20,pos:"A",name:"Esmir Bajraktarevic"},
    {n:21,pos:"D",name:"Stjepan Radeljic"},
    {n:22,pos:"G",name:"Martin Zlomislic"},
    {n:23,pos:"A",name:"Haris Tabakovic"},
    {n:24,pos:"D",name:"Malic"},
    {n:25,pos:"A",name:"Jovo Lukic"},
    {n:26,pos:"M",name:"Ermin Mahmic"},
  ]},
  {flag:"🇶🇦",name:"Qatar",group:"B",coach:"Julen Lopetegui",players:[
    {n:1,pos:"G",name:"Mahmoud Abunada"},
    {n:2,pos:"D",name:"Pedro Miguel"},
    {n:3,pos:"D",name:"Lucas Mendes"},
    {n:4,pos:"D",name:"Issa Laye"},
    {n:5,pos:"D",name:"Jassim Gaber"},
    {n:6,pos:"M",name:"Ahmed Fathy"},
    {n:7,pos:"A",name:"Ahmed Alaaeldin"},
    {n:8,pos:"A",name:"Edmilson Jr"},
    {n:9,pos:"A",name:"Mohammed Muntari"},
    {n:10,pos:"A",name:"Hassan Al-Haydos"},
    {n:11,pos:"A",name:"Akram Afif"},
    {n:12,pos:"M",name:"Karim Boudiaf"},
    {n:13,pos:"D",name:"Ayoub Al-Oui"},
    {n:14,pos:"D",name:"Homam Ahmed"},
    {n:15,pos:"A",name:"Yusuf Abdurisag"},
    {n:16,pos:"D",name:"Boualem Khoukhi"},
    {n:17,pos:"M",name:"Ahmed Al-Ganehi"},
    {n:18,pos:"D",name:"Sultan Al-Brake"},
    {n:19,pos:"A",name:"Almoez Ali"},
    {n:20,pos:"M",name:"Fathy"},
    {n:21,pos:"G",name:"Salah Zakaria"},
    {n:22,pos:"G",name:"Meshaal Barsham"},
    {n:23,pos:"M",name:"Assim Madibo"},
    {n:24,pos:"A",name:"Tahsin Jamshid"},
    {n:25,pos:"D",name:"Al-Hashmi Al-Hussain"},
    {n:26,pos:"A",name:"Mohamed Manai"},
  ]},
  {flag:"🇨🇭",name:"Suisse",group:"B",coach:"Murat Yakin",players:[
    {n:1,pos:"G",name:"Gregor Kobel"},
    {n:2,pos:"D",name:"Miro Muheim"},
    {n:3,pos:"D",name:"Silvan Widmer"},
    {n:4,pos:"D",name:"Nico Elvedi"},
    {n:5,pos:"D",name:"Manuel Akanji"},
    {n:6,pos:"M",name:"Denis Zakaria"},
    {n:7,pos:"A",name:"Breel Embolo"},
    {n:8,pos:"M",name:"Remo Freuler"},
    {n:9,pos:"M",name:"Johan Manzambi"},
    {n:10,pos:"M",name:"Granit Xhaka"},
    {n:11,pos:"A",name:"Dan Ndoye"},
    {n:12,pos:"G",name:"Yvon Mvogo"},
    {n:13,pos:"D",name:"Ricardo Rodriguez"},
    {n:14,pos:"M",name:"Ardon Jashari"},
    {n:15,pos:"M",name:"Djibril Sow"},
    {n:16,pos:"M",name:"Christian Fassnacht"},
    {n:17,pos:"A",name:"Rubén Vargas"},
    {n:18,pos:"D",name:"Eray Cömert"},
    {n:19,pos:"A",name:"Noah Okafor"},
    {n:20,pos:"M",name:"Michel Aebischer"},
    {n:21,pos:"G",name:"Marvin Keller"},
    {n:22,pos:"M",name:"Fabian Rieder"},
    {n:23,pos:"A",name:"Zeki Amdouni"},
    {n:24,pos:"D",name:"Aurèle Amenda"},
    {n:25,pos:"D",name:"Luca Jaquez"},
    {n:26,pos:"A",name:"Cedric Itten"},
  ]},
